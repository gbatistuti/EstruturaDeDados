	...
	public static void main( String[] args )
	   {
	       ...
	       try
	       {
	          input = new Scanner(new FileReader("disciplina.csv")).useDelimiter(",|\\r\\n");
	       }
	       ...
	       try // le dados do arquivo usando o Scanner
	       {
	          while ( input.hasNext() )
	          {
	              ...
	              // exibe os dados
	        	  System.out.printf( "%-14d%-30s%-12s%-12d%10d\n", disc.getIdDisc(),
